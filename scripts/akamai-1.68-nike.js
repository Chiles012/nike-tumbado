      ...
      : {
          ...
          gd: function () {
            var t = bmak.uar(),
              ...
              b = -1;
            try {
              n = 1366; // window.screen.availWidth 
            } catch (t) {
              n = -1;
            }
            try {
              o = 768; // window.screen.availHeight
            } catch (t) {
              o = -1;
            }
            try {
          ...
          get_browser: function () {
            navigator.productSub && (bmak.psub = navigator.productSub),
              navigator.language && (bmak.lang = "es-ES"),
              ...
              if (
                ...
                e && e.pageX && e.pageY
                  ...
                  : e &&
                    e.clientX &&
                    e.clientY &&
                    ((n = Math.floor(e.clientX)), (o = Math.floor(e.clientY)));
                var m = e.toElement;
                null == m && (m = e.target);
                var r = bmak.gf(m),
                ...
                void 0 !== e.isTrusted && !1 === e.isTrusted && (c += ",it0"),
                  (c += ";"),
            ...
            try {
              ...
              if (
                ...
                if (n && "mouse" != n.pointerType) {
                  ...
                  void 0 !== n.isTrusted && !1 === n.isTrusted && (i += ",0"),
              ...
              if (bmak.ke_cnt < bmak.ke_cnt_lmt && e) {
                ...
                if (0 == bmak.isIgn(n)) {
                  var u =
                    ...
                    "," +
                    k;
                  void 0 !== e.isTrusted && !1 === e.isTrusted && (u += ",0"),
                    (u += ";"),
          ...
          cta: function (t, a) {
            try {
              if (
                ...
                void 0 !== e.isTrusted && !1 === e.isTrusted && (r += ",0"),
          ...
          cdoa: function (t) {
            try {
              if (
                ...
                void 0 !== t.isTrusted && !1 === t.isTrusted && (m += ",0"),
            ...
            try {
              if (
                ...
                var s =
                  ...
                  "," +
                  d;
                void 0 !== t.isTrusted && !1 === t.isTrusted && (s += ",0"),
          ...
          startdoadma: function () {
            0 == bmak.doadma_en &&
              ...
              (window.addEventListener("deviceorientation", bmak.cdoa, !0),
            ...
            if (null != t)
              for (var o = 0; o < t.length; o++) {
                ...
                if (m.length > 0) {
                  for (
                    var r = m[0],
                      i = bmak.mn_abck + bmak.start_ts + m[2],
                      c = (m[3], m[6]),
                      b = 0;
                    b < bmak.mn_lcl && 1 == r && bmak.mn_lc[b] != i;
                    b++
                  );
                  b == bmak.mn_lcl &&
                    ((a = o), 2 == c && (e = o), 3 == c && (n = o));
            ...
            for (var v = 0; v < l; v++) {
              for (
                ...
                _ < 16
                  ? (g[_] = u[v][_])
                  : ((M =
                      bmak.rotate_right(g[_ - 15], 7) ^
                      bmak.rotate_right(g[_ - 15], 18) ^
                      (g[_ - 15] >>> 3)),
                    (j =
                      bmak.rotate_right(g[_ - 2], 17) ^
                      bmak.rotate_right(g[_ - 2], 19) ^
                      (g[_ - 2] >>> 10)),
                    (g[_] = g[_ - 16] + M + g[_ - 7] + j)),
                  (j =
                    bmak.rotate_right(C, 6) ^
                    bmak.rotate_right(C, 11) ^
                    bmak.rotate_right(C, 25)),
                  (A = (C & h) ^ (~C & B)),
                  (L = x + j + A + a[_] + g[_]),
                  (M =
                    bmak.rotate_right(w, 2) ^
                    bmak.rotate_right(w, 13) ^
                    bmak.rotate_right(w, 22)),
                  (P = (w & y) ^ (w & E) ^ (y & E)),
                  (T = M + P),
                  (x = B),
                  (B = h),
            ...
            try {
              for (
                ...
                if (0 == bmak.bdm(i, m))
                  ...
                  (a += 1) % 1e3 == 0 &&
                  (e = bmak.get_cf_date() - o) > bmak.mn_stout
                )
                  return (
                    (bmak.mn_wt += e), void setTimeout(bmak.mn_w, bmak.mn_stout)
                  );
              }
              (bmak.mn_mc_indx += 1),
                bmak.mn_mc_indx < bmak.mn_mc_lmt
          ...
          listFunctions: {
            ...
            _setFsp: function (t) {
              (bmak.fsp = t),
                bmak.fsp &&
                  (bmak.cf_url = bmak.cf_url.replace(
                    /^http:\/\//i,
                    "https://"
                  ));
            },
    ...
    (t.fpcf = a),
      ...
      (a.fonts_optm = function () {
        ...
        if (!a.sf4() && document.body) {
          ...
          for (
            document.body.appendChild(i), c = 0;
